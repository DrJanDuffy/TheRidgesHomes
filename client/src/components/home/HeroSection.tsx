      ...
      <div className="container mx-auto h-full px-4 md:px-8 relative z-10 flex flex-col justify-center">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <Link href="/listings">
              <Button className="px-8 py-3 h-auto bg-secondary hover:bg-secondary-dark text-white font-secondary font-medium text-center">
                View Luxury Listings
              </Button>
            </Link>
            <Link href="/resources">
              <Button variant="outline" className="px-8 py-3 h-auto bg-white bg-opacity-20 backdrop-blur-sm hover:bg-opacity-30 text-white border border-white border-opacity-40 font-secondary font-medium text-center">
